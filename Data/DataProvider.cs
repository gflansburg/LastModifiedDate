...
namespace Gafware.Modules.LastModifiedDate.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Gafware.Modules.LastModifiedDate.Data.SqlDataprovider,Gafware.LastModifiedDate";
        ...
        public abstract IDataReader GetTabLastModifiedDate(int tabId);        
